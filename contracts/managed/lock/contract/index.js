...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      lockSecret: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`lockSecret: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const hash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('lockSecret',
                                     'argument 1 (as invoked from Typescript)',
                                     'lock.compact line 25 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(hash_0),
        ...
        const result_0 = this._lockSecret_0(context, partialProofData, hash_0);
      ...
      checkAndRelease: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`checkAndRelease: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkAndRelease',
                                     'argument 1 (as invoked from Typescript)',
                                     'lock.compact line 44 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._checkAndRelease_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      getSecretHash: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getSecretHash: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getSecretHash',
                                     'argument 1 (as invoked from Typescript)',
                                     'lock.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._getSecretHash_0(context, partialProofData);
    ...
    this.impureCircuits = {
      lockSecret: this.circuits.lockSecret,
      checkIn: this.circuits.checkIn,
      checkAndRelease: this.circuits.checkAndRelease,
      getSecretHash: this.circuits.getSecretHash,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('lockSecret', new __compactRuntime.ContractOperation());
    state_0.setOperation('checkIn', new __compactRuntime.ContractOperation());
    state_0.setOperation('checkAndRelease', new __compactRuntime.ContractOperation());
    state_0.setOperation('getSecretHash', new __compactRuntime.ContractOperation());
  ...
  _publicKey_0(round_0, sk_0) {
    return this._persistentHash_0([new Uint8Array([109, 105, 100, 110, 105, 103, 104, 116, 58, 115, 105, 108, 101, 110, 116, 115, 105, 103, 110, 97, 108, 58, 112, 107, 0, 0, 0, 0, 0, 0, 0, 0]),
                                   __compactRuntime.convertFieldToBytes(32,
                                                                        round_0,
                                                                        'lock.compact line 18 char 43'),
                                   sk_0]);
  }
  _lockSecret_0(context, partialProofData, hash_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            0,
                            'Secret already locked');
    const sk_0 = this._secretKey_0(context, partialProofData);
    const pk_0 = this._publicKey_0(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
                                                                                              { dup: { n: 0 } },
                                                                                              { idx: { cached: false,
  ...
  _checkAndRelease_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _getSecretHash_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
